...
class BinaryDiffusionCoefficients:
    ...
    def H_D(self, T):
        """From Genda & Ikoma 2008 for D in H (not measured directly)."""
    ...
    def He_D(self, T):
        """Approximated from H_D using Genda/Ikoma 2008 prescription (Appendix C)."""
        return 5.087e19 * T**0.728

    def H_O(self, T):
        """From Wordsworth et al 2018."""
        return 4.8e19 * T**0.75

    def He_O(self, T):
        """Approximated from H_O using Genda/Ikoma 2008 prescription (Appendix C)."""
    ...
    def He_C(self, T):
        """Approximated from He_O using Genda/Ikoma 2008 prescription (Appendix C)."""
