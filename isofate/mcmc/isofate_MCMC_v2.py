...
# <<< CHANGED: This entire function is no longer necessary and is commented out
# def collect_model_outputs(sampler, n_samples=1000):
#     """
#     Collect model outputs by re-running the best samples
#     """
#     # ... [function content removed for brevity] ...
...
def main():
    ...
    output_filename = 'IsoFATE_LHS1140b_MCMC_results_n1e5_natmod0_eps15_tjump_Ffinal17_constant_tpms_OH_12w_50s.pickle'
